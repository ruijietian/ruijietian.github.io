...
function main() {
  /* The main logic of our widget */
    ...
    function bgUrl(data) {
        var base = 'https://clustrmaps.com/generated_content/backs/bg';
        var ap = ['w', 'co', 'cl'];
        var p = [];
        for ( var i in ap ) {
           var v = ap[i];
    ...
    function counterCode() {
        ...
        $.ajax({
            ...
            cache: false,
            data: data,
            url: "https://clustrmaps.com/widget_call_home.js",
